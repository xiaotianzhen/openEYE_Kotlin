...
import com.huanting.openeye.ui.fragment.notify.view.InteractFragment
import com.huanting.openeye.ui.fragment.notify.view.NotificationFragment
import com.huanting.openeye.ui.fragment.notify.view.TopicFragment
...
class NotifyFragment : BaseFragment() {
    ...
    private var titles= arrayListOf("主题","推送","互动")

    override fun initView() {
      im_can.visibility=View.GONE

        tab_lalyout.setupWithViewPager(vp_notify)
        tab_lalyout.addOnTabSelectedListener(object :TabLayout.OnTabSelectedListener{
            ...
            override fun onTabSelected(p0: TabLayout.Tab?) {
                vp_notify.setCurrentItem(p0!!.position,false)
            }
