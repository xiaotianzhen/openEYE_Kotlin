...
import com.huanting.openeye.ui.fragment.notify.InteractFragment
import com.huanting.openeye.ui.fragment.notify.NotificationFragment
import com.huanting.openeye.ui.fragment.notify.TopicFragment
...
class NotifyFragment : BaseFragment() {
    ...
    private var titles= arrayListOf("推送","互动","私信")
